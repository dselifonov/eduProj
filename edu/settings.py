...
SECRET_KEY = '_hg*zriczf_9$v@ld!1qvpgkj$^@5ad3xox(%hn7@ne1+39rf@'
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("EDU_DB_NAME", "edu_db"),
        "USER": os.getenv("EDU_DB_USER", "postgres"),
